report 50088 "UTT Fixed Asset-Book Value 03"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layout/FixedAssetBookValue03.rdlc';
    ApplicationArea = FixedAssets;
    Caption = 'UTT FA Book Value 03';
                    ...
                    case i of
                        1:
                            begin
                                ...
                                // uttde FAGenReport.SetExclReclEntries(false);
                            end;
                        2:
                            begin
                                PostingType := FADeprBook.FieldNo(Depreciation);
                                // uttde FAGenReport.SetExclReclEntries(false); // Set to FALSE for i >= 2
                            end;
                        3:
