report 50087 "UTT Fixed Assets - List AT"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layout/FixedAssetsListAT.rdlc';
    ...
    dataset
    {
        dataitem("Fixed Asset"; "Fixed Asset")
        {
            ...
            // }
            //uttde Start
             column(Fixed_Asset__BWR_Depr__Book_Code_; '')
            {
            }
            column(Fixed_Asset__Prem_Depr____;'')
            {
            } 
            //uttde end
            ...
            // {
            // }
             column(Fixed_Asset__Prem__Depr__Amount_;0)
            {
            }
