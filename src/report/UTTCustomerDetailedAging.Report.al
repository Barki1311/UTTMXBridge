report 50090 "UTT Customer Detailed Aging"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layout/CustomerDetailedAging.rdlc';
    AdditionalSearchTerms = 'customer balance,payment due';
    ApplicationArea = Basic, Suite;
    Caption = 'UTT Customer Detailed Aging';
    ...
    var
     ...
     Test01Lbl: Label 'barki', Comment = '%1 is barki';
